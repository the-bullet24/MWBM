...
public class Usuario extends User {
	...
	public Usuario(String username, String password, Collection<? extends GrantedAuthority> authorities,
			String codigoEmpleado, String codigoArea, String nombreArea, String apPaterno, String apMaterno,
			String nombres, String dni, String cargo,List<String> permisos) {
	...
	public Usuario(String username, String password, Collection<? extends GrantedAuthority> authorities,
			String nombreArea, String apPaterno, String apMaterno, String nombres, List<String> permisos) {
		super(username, password, authorities);
		this.nombreArea = nombreArea;
		this.apPaterno = apPaterno;
		this.apMaterno = apMaterno;
